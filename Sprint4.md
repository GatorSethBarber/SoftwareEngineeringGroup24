...
Please find below two links to video recordings of our group's work. The first video showcases the new features and tests of Gift Card Xchange for Sprint 4, and includes a demonstration of the full process of using the web application. The second video provides a more detailed look at the functionalities of the back-end.
* (1) https://youtu.be/G4OISgIiA18
* (2) https://youtu.be/OJ3bd38jObQ
